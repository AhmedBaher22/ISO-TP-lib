    ...
    with can.Bus(interface="vector", channel=channel_number, app_name="UDS", fd=fd_flag) as bus:
        ...
        while True:
            ...
            if msg:
                ...
                # write data by indetifier
                ...
                elif msg.data[1]==0x31 and msg.data[4]==0x02:


                    ack_msg = can.Message(arbitration_id=0x33, data=[0x05, 0x71, 0x01, 0xFF, 0x02, 0x00],
                                          is_extended_id=extended_flag, is_fd=fd_flag)
                    time -= 1
                    flg = True
                    ...
                    ack_msg = can.Message(arbitration_id=0x33, data=[0x05, 0x71, 0x01, 0xFF, 0x00, 0x00],
                                          is_extended_id=extended_flag, is_fd=fd_flag)
                    time -= 1
                    flg = True
